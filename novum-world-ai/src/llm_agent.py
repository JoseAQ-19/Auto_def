...
def generate_novum_prompt(topic: str) -> str:
    ...
    system_prompt = (
        ...
        "Tu ÚNICA tarea es estructurar la respuesta ESTRICTAMENTE en estos tres apartados:\n\n"
        "Metadatos\n"
        "Título: (Un título muy corto, visual y SEO para TikTok/YouTube/Instagram).\n"
        "Descripción: (Una descripción misteriosa sobre el vídeo, invitando al debate).\n"
        "Hashtags: (3 o 4 hashtags separados por comas, incluyendo siempre 'novum, IA, shorts').\n\n"
        "Guion del video\n"
